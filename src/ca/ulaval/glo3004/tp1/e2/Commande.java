...
public class Commande {
	...
	private final List<String> VOITURES_ACTIONS = Arrays.asList("attendV", "arrive", "tourneDroite", "tourneGauche",
			"continue");
	...
	public boolean estValide() {
		return (estPourLumiere() || estPourLumierePieton() || estPourVoiture() || estPourPieton());
	}
